...
class FilmControllerTest {
    ...
    public void whenRequestFilmListPageThenGetPageWithFilms() {
        var film1 = new FilmDto(3, "Крушение", "Пилоту Броуди Торрансу удаётся успешно "
                + "посадить повреждённый штормом самолёт на враждебной территории. Вскоре выясняется, что уцелевшим угрожают "
                + "местные повстанцы, которые хотят захватить пассажиров в заложники. Броуди должен защитить людей, пока не "
                + "прибудет помощь.", 2023, "Боевик", 16, 107, 3);
        var film2 = new FilmDto(10, "Брат 2", "Участвуя в программе на телевидении, Данила Багров встречает своих"
