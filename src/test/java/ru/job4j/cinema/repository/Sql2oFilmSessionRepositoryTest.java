...
class Sql2oFilmSessionRepositoryTest {
    ...
    private static FilmSession filmSession1 = new FilmSession(1, 9, 1, LocalDateTime.of(2023, 03, 30, 01, 00, 00), LocalDateTime.of(2023, 03, 30, 02, 47, 00), 150);

    private static FilmSession filmSession2 = new FilmSession(2, 7, 2, LocalDateTime.of(2023, 03, 30, 01, 24, 00), LocalDateTime.of(2023, 03, 30, 04, 00, 00), 250);
